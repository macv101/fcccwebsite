...
/*
 * Modified by Nick Cates on 31th October 2009 for D Scribe 2 functionality.
 */
...
/* Auto Toolbar Divider */

$("#toolbar ul li a").prepend("<span></span>");
$("#toolbar ul li a span:first").addClass("noLine");


/* Pretext for Google Search */

$('.searchField').example(function() {
return $(this).attr('title');
}, {className: 'searchFiller'});});
...
var arrowimages={down:['navDown'], right:['navRight']}
var menu={
...
menu.buildmenu("toolbar", arrowimages)